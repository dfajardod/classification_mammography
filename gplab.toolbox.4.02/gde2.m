function newinds=gde2(pop,params,state,data,indlist)
%GDE2    Creates a new GPLAB individual by GDE operators version 2.
%   NEWIND=GDE2(POPULATION,PARAMS,STATE,DATA,PARENT) returns one new
%   individual created by GDE operators (ER uses version 2, see ref)
...
params.gdeW1=W;
params.gdeW2=1-W;
U=gdeER2(tmppop,params,state,data,[1,2]);
