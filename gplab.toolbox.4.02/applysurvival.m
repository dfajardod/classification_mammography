...
%   APPLYSURVIVAL(OLDPOP,PARAMS,STATE,NEWPOP) returns a population of
%   individuals chosen between the individuals of the previous current
%   population, OLDPOP, and the individuals newly created, in NEWPOP,
%   applying the elitism level and survival method specified in PARAMS.
%   The population returned is ordered by priority of survival.
%
%   Input arguments:
